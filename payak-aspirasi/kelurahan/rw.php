...
<body>
    ...
    <ons-page id="page1" style="background-color: red;">
        ...
        <p align="center">
            <ons-button id="push-button">+ tambah rw</ons-button>
            <a href="index.php"><ons-button> Back</ons-button></a>
        </p>

        <table>
            <tbody>
                <?php
                $query = mysqli_query($conn, "SELECT * FROM data_rw");
                ...
                <tr>
                    ...
                    <td data-label="No Telepon"><?= $data['no_telp']?></td>
                    <td data-label="Alamat"><?= 'Rt.' .$data['rt'] .' / Rw.' .$data['rw']?></td>
                    <td data-label="Status">
                        <?php 
                        if($data['stats'] == "aktif"){
                            echo '<ons-icon style="color: green;" icon="md-check"></ons-icon> Aktif</td>';
                        } else {
                            echo '<ons-icon style="color: red;" icon="md-cross"></ons-icon> Tdak Aktif</td>';
                        }
                        ?> 
                    <td data-label="">
                        <a href="edit_data.php?page=rw&id=<?= $data['id_user']?>">
                            <ons-button modifier="material">
                                <ons-ripple></ons-ripple>
                                    edit
                            </ons-button>
                        </a>
                        <a href="../function/db_admin.php?act=delete_rw&id=<?= $data['id_user']?>">
                            <ons-button modifier="material">
                                <ons-ripple></ons-ripple>
                                delete
                            </ons-button>
    ...
    <ons-page id="page2">
        <ons-toolbar>
            <div class="left"><ons-back-button>Tambah Data</ons-back-button></div>
            <div class="center"></div>
        </ons-toolbar>
        <div style="text-align: center">
            <form action="../function/db_admin.php?act=add_rw" method="POST">
                <?php
                $query = "SELECT max(id_user) as maxKode FROM data_rw";
                ...
                <section style="padding: 8px">
                <input type="text" class="text-input input-res" ng-model="text" name="nik" placeholder="NIK" style="display: block; width: 100%">
                </section>

                <section style="padding: 8px">
                <input type="text" class="text-input input-res" ng-model="text" name="nama" placeholder="Nama" style="display: block; width: 100%">
                </section>

                <section style="padding: 8px">
                <input type="text" class="text-input input-res" ng-model="text" name="telp" placeholder="No Telepon" style="display: block; width: 100%">
                </section>
                ...
                <section style="padding: 8px">
                <input type="password" class="text-input input-res" ng-model="text" name="pass" placeholder="Password" style="display: block; width: 100%">
                </section>
                <br>
