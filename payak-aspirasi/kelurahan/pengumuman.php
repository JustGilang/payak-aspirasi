...
<body>
    ...
    <template id="page1.html" background-color: red;>
        <ons-page id="index">
            <ons-toolbar>
                <div class="center">Tambah Pengumuman</div>
            </ons-toolbar>
            <div style="text-align: center">
                <form action="../function/db_admin.php?act=add_pengumuman" method="POST">
                    <?php
                    $query = "SELECT max(id_pengumuman) as maxKode FROM data_pengumuman";
                    ...
                    <input type="hidden" class="text-input input-res" ng-model="text" name="id_usr" value="<?= $_SESSION['id_user'];?>" style="display: block; width: 100%">
                    </section>
                    ...
                    <section style="padding: 8px">
                    <input type="text" class="text-input input-res" ng-model="text" name="subjek" placeholder="Isi Subjek" style="display: block; width: 100%">
                    </section>

                    <section style="padding: 8px">
                    <input type="date" class="text-input input-res" ng-model="text" name="date" placeholder="Isi Subjek" style="display: block; width: 100%">
                    </section>

                    <section style="padding: 8px">
                    <input type="time" class="text-input input-res" ng-model="text" name="waktu" placeholder="Time" style="display: block; width: 100%">
                    </section>

                    <section style="padding: 8px">
                    <input type="text" class="text-input input-res" ng-model="text" name="lokasi" placeholder="Isi Lokasi" style="display: block; width: 100%">
                    </section>

                    <section style="padding: 8px">
                    <input type="text" class="text-input input-res" ng-model="text" name="rt" placeholder="Isi RT" style="display: block; width: 100%">
                    </section>

                    <section style="padding: 8px">
                    <input type="text" class="text-input input-res" ng-model="text" name="rw" placeholder="Isi RW" style="display: block; width: 100%">
                    </section>

                    <section style="padding: 8px">
                    <textarea id="" class="text-input input-res" ng-model="text" name="isi" placeholder="Isi Pengumuman" style="display: block; width: 100%; height:150px;"><?= $data['isi']?></textarea>
                    </section>
