...
<body>
    ...
    <ons-page id="page1" style="background-color: red;">
        ...
        <table>
            <tbody>
                <?php
                $query = mysqli_query($conn, "SELECT * FROM data_rt");
                ...
                <tr>
                    ...
                    <td data-label="Status">
                        ...
                        ?> 
                    <td data-label="">
                        <a href="edit_data.php?page=rt&id=<?= $data['id_user']?>">
                            <ons-button modifier="material">
                                <ons-ripple></ons-ripple>
                                    edit
                            </ons-button>
                        </a>
                        <a href="../function/db_admin.php?act=delete_rt&id=<?= $data['id_user']?>">
                            <ons-button modifier="material">
                                <ons-ripple></ons-ripple>
                                delete
                            </ons-button>
    ...
    <ons-page id="page2">
        ...
        <div style="text-align: center">
            <form action="../function/db_admin.php?act=add_rt" method="POST">
                <?php
                $query = "SELECT max(id_user) as maxKode FROM data_rt";
