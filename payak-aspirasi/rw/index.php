    ...
    <template id="pengumuman">
        <ons-page id="Tab3">
            ...
            <table>
                ...
                <tbody>
                    <?php
                    $user = mysqli_query($conn, "SELECT * FROM data_rw WHERE id_user = '$_SESSION[id_user]'");
                    $ambil = mysqli_fetch_array($user);

                    $sql = mysqli_query($conn, "SELECT * FROM data_pengumuman WHERE rt='$ambil[rt]' AND rw='$ambil[rw]' ");
                    while($data = mysqli_fetch_array($sql)){
                    ?>
                    <tr>
                        <td data-label="Pengumuman"><?= $data['subjek']?></td>
                        <td data-label="RT/RW"><?= $data['rt'] .' / ' .$data['rw']?></td>
                        <td data-label="Tanggal"><?= $data['tanggal']?></td>
                        <?php
                        if($data['id_user']=='KL-001'){
                            echo '
                                <td data-label="">
                                    <a href="detail_data.php?page=dtl_pengumuman&id=' .$data['id_pengumuman'] .'">
                                        <ons-button modifier="material">
                                            <ons-ripple></ons-ripple>
                                            view more
                                        </ons-button>
                            ...
                            echo '
                                <td data-label="">
                                    ...
                                    <a href="edit_data.php?page=edit_pengumuman&id=' .$data['id_pengumuman'] .'">
                                        <ons-button modifier="material">
                                            <ons-ripple></ons-ripple>
                                            edit
                                        </ons-button>
